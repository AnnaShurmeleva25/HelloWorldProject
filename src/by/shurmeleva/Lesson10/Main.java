package by.shurmeleva.Lesson10;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(myBestString = myBestString.trim());// уберает пробелы в начале и в конце строки
        myBestString = myBestString.trim();
        System.out.println(myBestString.length());

        System.out.println(myBestString.charAt(5)); // взять сисвол в строке.
