...
public class CreditCard {
    ...
    public CreditCard(String ownerName, CurrencyType currency, String date, long cardNumber, int balance)
            throws MinusCardNumberException, ShortOwnerNameException {
        if (ownerName.length() < 4) throw new ShortOwnerNameException(ownerName);
